...
class KeyBoardControls:
    def __init__(self) -> None:
        ...
        self.isRPressedSwitch: bool = False
        self.rJustPressed: bool = False
        self._last_r_state: bool = False
    ...
    def update(self):
        ...
        self.rJustPressed = False  # ✅ ADDED (one-frame)
        ...
        # ✅ ADDED: R "just pressed" (keyboard)
        kb_r = bool(keys[pygame.K_r])
        if kb_r and not self._last_r_state:
            self.rJustPressed = True
            if self.debug_input:
                print("[INPUT] R JUST PRESSED (KEYBOARD)")
        self._last_r_state = kb_r
        ...
        if self.joystick is not None:
            ...
            if r_held and not self.isRPressedSwitch:
                self.rJustPressed = True
                if self.debug_input:
                    print("[INPUT] R JUST PRESSED (CONTROLLER)")
            self.isRPressedSwitch = r_held
