...
class MissionBriefingScreenLevelNine(Screen):
    def __init__(self):
        super().__init__()
        ...
        self.briefing_text = [
            ...
            "Enemy units are calibrated for these conditions, giving them a significant advantage.",
            "",
    ...
    def _try_deploy(self, state) -> None:
        ...
        next_level = LevelNine(state.textbox)
